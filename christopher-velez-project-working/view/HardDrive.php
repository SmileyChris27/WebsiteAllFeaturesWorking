...
<header class="masthead">
        <h1>SSD vs HDD Which one is better?</h1>
        <h1>Click PC Hardware Products to go back</h1>
...
<main id="content" class="main-content">
        <img src="images/HardDriveHDD.gif" alt ="HardDriveHDD" width="300" height="150"></aside>
    </main>
...
<script>
    function myFunction() {
      ...
      function myFunction1() {
          document.getElementById("Answer").innerHTML = "SSD";
